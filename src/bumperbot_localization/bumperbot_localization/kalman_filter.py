...
class KalmanFilter(Node):
    ...
    def odomCallback(self, odom):
        ...
        self.measurementUpdate() # Measurment comming from the Imu sensor -> then a posterior probability canbe calculated represent a better estimation of angular velocity z
